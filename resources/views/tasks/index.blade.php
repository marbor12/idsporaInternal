        ...
        <div class="p-6 max-w-6xl mx-auto">
            ...
            <div class="bg-white border rounded p-4 mb-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                <div class="relative col-span-2">
                    ...
                    <input type="text" placeholder="Search task (title/description)" class="pl-10 border rounded px-3 py-2 w-full">
                </div>
                    ...
                    <tbody>
                        @foreach ($tasks as $task)
                            ...
                            <tr class="border-b text-center">
                                ...
                                <td class="py-2">
                                    <span class="px-2 py-1 rounded text-xs {{ $badge }}">{{ ucfirst(str_replace('_', ' ', $task['status'])) }}</span>
                                </td>
                                <td class="py-2">

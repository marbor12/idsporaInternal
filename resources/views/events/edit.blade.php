    ...
    <div class="flex-1 overflow-auto p-4">
        <div>
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ route('events.index') }}" class="px-4 py-2 bg-gray-400 text-white rounded-md hover:bg-gray-600 transition-colors flex items-center gap-2">
            ...
            <div class="bg-white border rounded p-6 mb-6">
                <form action="{{ route('events.update', $event['id']) }}" method="POST">
                    ...
                    <div class="mt-6 flex justify-end gap-3">
                        <a href="{{ route('events.index') }}" class="px-4 py-2 bg-gray-400 text-white rounded-md hover:bg-gray-600 transition-colors">
                            Cancel
                        </a>
